...
public class TractorController : MonoBehaviour
{
    ...
    public UnityEvent<TractorController> onCowCollected;
    public UnityEvent<TractorController> onFinish;
    public UnityEvent<TractorController> onRollOver;
    public UnityEvent<TractorController> onReset;
    ...
    private void FixedUpdate()
    {
        ...
        if (isStopped && Input.GetKey(KeyCode.P))
        {
